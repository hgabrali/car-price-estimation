...
# MAGIC %pip install shap lime "numpy<2" --quiet
...
inner_model = final_model.named_steps['model']
lime_explainer = lime.lime_tabular.LimeTabularExplainer(training_data=X_train_arr, mode='regression', random_state=RANDOM_STATE, verbose=False)
